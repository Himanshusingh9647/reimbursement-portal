  ...
  return (
    <div className="p-6 w-full max-w-none mx-auto flex flex-col gap-6">
      <div className="pb-4 border-b border-border bg-gradient-to-b from-blue-50/30 to-transparent -mx-6 px-6 pt-2 mb-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h1 className="font-serif text-2xl font-semibold text-gray-900 dark:text-white">Domestic Travel Rates</h1>
        <div>
          <button 
            disabled={saving}
            onClick={handleSave}
      ...
      <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-sm border border-border">
        <h2 className="text-lg font-serif font-medium text-gray-900 dark:text-white mb-6 border-b border-border pb-2">Per Diem</h2>
          ...
          {clLevels.map(cl => (
            <div key={cl} className="flex flex-col gap-1">
              ...
              <input 
                ...
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-samsung-blue focus:border-samsung-blue sm:text-sm font-mono text-gray-900 dark:text-white"
              />
            </div>
          ))}
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-sm border border-border">
        <h2 className="text-lg font-serif font-medium text-gray-900 dark:text-white mb-6 border-b border-border pb-2">Hotel Caps</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                <th scope="col" className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">CL Level</th>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-4 italic">* Leave blank for uncapped (Actuals)</p>
      </div>
