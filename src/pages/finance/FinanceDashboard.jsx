...
export default function FinanceDashboard() {
  ...
  return (
    <div className="p-6 w-full max-w-none mx-auto flex flex-col gap-8">
      ...
      <div className="mt-4">
        <h2 className="font-serif text-xl font-semibold text-gray-900 mb-4">New Requests (Pending)</h2>
      ...
      <div className="mt-4">
        <h2 className="font-serif text-xl font-semibold text-gray-900 mb-4">Processed Requests</h2>
        <div className="bg-white rounded-md border border-border overflow-hidden shadow-sm">
          <DataTable 
            columns={columns} 
