                    ...
                    {Object.entries({
                      ...
                      return (
                        <div key={key} className="flex items-center justify-between border border-gray-200 p-4 rounded-lg bg-white shadow-sm hover:border-gray-300 transition-colors">
                          ...
                          {files?.length > 0 && (
                            <button 
                              onClick={() => setToast({ visible: true, message: 'Document preview is not available in the prototype', type: 'error' })}
                              className="flex items-center gap-1.5 text-xs font-medium text-samsung-blue hover:text-blue-800 bg-blue-50 px-3 py-1.5 rounded-md"
                            >
                              <Eye size={14} /> View
                            </button>
                          )}
