  ...
  return (
    <div className="p-6 w-full max-w-none mx-auto flex flex-col gap-6">
      <div className="pb-4 border-b border-border bg-gradient-to-b from-blue-50/30 to-transparent -mx-6 px-6 pt-2 mb-2">
        <h1 className="font-serif text-2xl font-semibold text-gray-900 dark:text-white">Internet Caps</h1>
      </div>

      <form onSubmit={handleSave} className="flex flex-col gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-sm border border-border">
          <h2 className="text-lg font-serif font-medium text-gray-900 dark:text-white mb-6 border-b border-border pb-2">Monthly Limit (₹)</h2>
            ...
            {clLevels.map(cl => (
              <div key={cl} className="flex items-center gap-4">
                ...
                <input 
                  ...
                  className="flex-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-samsung-blue focus:border-samsung-blue sm:text-sm font-mono text-gray-900 dark:text-white"
                  required
                />
              </div>
            ))}
